...
export class MenuBottomComponent {
    ...
    items: NavItem[] = [
      { label: 'Home', route: '/', key: '', path:"M12 3l9 8h-3v7a1 1 0 0 1-1 1h-4v-5H11v5H7a1 1 0 0 1-1-1v-7H3l9-8z" },
      { label: 'Matches', route: '/matches', key: 'matches', path:"M7 10h5v5H7zM3 5h1V3h2v2h10V3h2v2h1a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zM3 8v11h18V8H3z" },
      { label: 'Bets', route: '/bethistory', key: 'bethistory', path:"M2 7v10a2 2 0 0 0 2 2h16V5H4a2 2 0 0 0-2 2zm6 5a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" },
